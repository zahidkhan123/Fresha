      ...
      <CardBody>
        <Row className='pb-50'>
          ...
          >
            <div className='session-info mb-1 mb-lg-0'>
              ...
              <CardText className='font-weight-bold mb-2'>Total Appointments</CardText>
            ...
            <Button color='dark' className='button_slide slide_right p-1  '>
        ...
        <Row className='pt-50'>
          <Col className='mb-2' md='6' sm='12'>
            <p className='mb-50'>Online Appointments: {data.goal}</p>
          ...
          <Col md='6' sm='12'>
            <p className='mb-50'>Occupancy: {data.retention}%</p>
